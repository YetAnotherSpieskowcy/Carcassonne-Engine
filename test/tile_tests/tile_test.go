...
func TestTileRotate(t *testing.T) {
	...
	result.Fields.Fields = append(result.Fields.Fields, Connection.Connection{[]Connection.Side{Connection.LEFT_BOTTOM_EDGE, Connection.BOTTOM_LEFT_EDGE}})
...
func TestTileToString(t *testing.T) {
	...
	result += "Fields\n"
	result += Connection.Connection{[]Connection.Side{Connection.BOTTOM_RIGHT_EDGE, Connection.RIGHT_BOTTOM_EDGE}}.ToString() + "\n"
